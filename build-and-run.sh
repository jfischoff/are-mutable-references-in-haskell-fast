...
stack exec ghc-core -- --no-syntax -- -O2 src/IORefLoop.hs > core/IORefLoop.core
bench -L60 ./bin/mutable-byte-buffer-loop
stack exec ghc-core -- --no-syntax -- -O2 src/MutableByteBufferLoop.hs > core/MutableByteBufferLoop.core
bench -L60 ./bin/ptr-loop
stack exec ghc-core -- --no-syntax -- -O2 src/PtrLoop.hs > core/PtrLoop.core
bench -L60 ./bin/vector-loop
stack exec ghc-core -- --no-syntax -- -O2 src/VectorLoop.hs > core/VectorLoop.core
